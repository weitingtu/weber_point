...
//void VisibilityGraph::create2( const QVector<QPointF>& sources,
//                               const QVector<QPolygonF>& source_polies, const QVector<QPolygonF>& obs, const QVector<QPointF>& targets )
//{
//    QVector<QPointF> points = sources;
//    int label = 0;
//    QVector<int> labels(points.size(), label);

//    for(const QPolygonF& p : source_polies )
//    {
//        ++label;
//        for(int i = 0; i <p.size() - 1; ++i)
//        {
